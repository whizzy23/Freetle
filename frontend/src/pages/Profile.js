...
import profileIcon from "../assets/member1.png";
        ...
        <Col md={6}>
          <Card className="text-center">
            <Image
              variant="top"
              src={profileIcon}
              className="rounded-circle mx-auto mt-4 border border-1 border-dark "
              width={150}
              height={150}
            />
            <Card.Body>
              <Card.Title>{userData.name}</Card.Title>
              <Card.Text className="lead fst-italic">
                {userData.penName}
              </Card.Text>
              <Card.Text>{userData.bio}</Card.Text>
              <Button variant="dark" className="mb-3" onClick={handleShowModal}>
                Edit Profile
              </Button>
            </Card.Body>
          </Card>
