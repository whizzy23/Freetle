...
const StoryForm = ({userData}) => {
    ...
    <>
        <div className="text-center my-4">
            <Button variant="dark" onClick={handleOpenModal}>Upload Story</Button>
        </div>
            ...
            <Modal.Body className='p-4'>
              <Form>
                <Form.Group className='fw-bold' controlId="formTitle">
                  ...
                  <Form.Control type="text" name="title" placeholder="Enter title" value={newStory.title} onChange={handleInputChange} />
                </Form.Group>
                <Form.Group className='fw-bold' controlId="formDescription">
                  <Form.Label>Description</Form.Label>
                  <Form.Control as="textarea" rows={3} name="description" placeholder="Enter description" value={newStory.description} onChange={handleInputChange} />
                </Form.Group>
                <Form.Group className='fw-bold' controlId="formContent">
                  <Form.Label>Content</Form.Label>
                  <Form.Control as="textarea" rows={5} name="content" placeholder="Enter content" value={newStory.content} onChange={handleInputChange} />
                </Form.Group>
            ...
            <Modal.Body>
              <Form>
                <Form.Group controlId="formPenName">
                  ...
                  <Form.Control type="text" placeholder="Enter your pen name" value={penName} onChange={(e) => setPenName(e.target.value) } />
                </Form.Group>
                {penNameError && <Alert variant="danger" className="mt-2">{penNameError}</Alert>}
              </Form>
            </Modal.Body>
            <Modal.Footer>
              <Button variant="secondary" onClick={handleClosePenNameModal}>Cancel</Button>
              <Button variant="dark" onClick={handlePenNameSubmit}>Submit</Button>
            </Modal.Footer>
        </Modal>
    </>
    )
